    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans">
      ...
      <div className="bg-slate-900/60 border-b border-slate-800/80 py-10">
        <div className="max-w-7xl mx-auto px-4 md:px-6 space-y-6 text-center">
          <h1 className="text-3xl md:text-4xl font-extrabold text-white">Explore Course Catalog</h1>
        ...
        <div className="lg:col-span-3 space-y-6">
          {loading ? (
            ...
            <div className="p-12 text-center bg-slate-900 border border-slate-800 rounded-3xl space-y-3">
              ...
              <p className="text-slate-400 text-xs">Try clearing filters or search with another keyword.</p>
            </div>
          ) : (
                ...
                >
                  ...
                  <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                    ...
                    <Link
                      ...
                      className="w-full py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold rounded-xl shadow-lg shadow-indigo-600/30 text-center transition"
                    >
                      Enroll Now
                    </Link>
                  </div>
